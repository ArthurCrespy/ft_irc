...
#define ERR_NOTEXTTOSEND(source, nickname)					"412 " + source + " " + nickname + " :No text to send"


/* Numeric Responses */

#define RPL_WELCOME(source)									"001 " + source + " :Welcome to the ft_irc network"
#define RPL_WELCOME0(nickname) (":localhost 001 " + nickname + " :Welcome to the Internet Relay Network " + nickname + "\r\n") // used
