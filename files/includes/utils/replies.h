...
# define ERR_PASSWDMISMATCH(nickname)						"464 " + nickname + " :Password is incorrect"
...
# define ERR_NOSUCHNICK(nickname, request)					"401 " + nickname + " " + request + " :No such nick/channel"
# define ERR_USERNOTINCHANNEL(nickname, request, channel)	"441 " + nickname + " " + request + " " + channel + " :They aren't on that channel"

# define ERR_NOTEXTTOSEND(nickname, request)				"412 " + nickname + " " + request + " :No text to send"
